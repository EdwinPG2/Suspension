                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="saludo" id="saludo" class="form-control" rows="3"
                                        ...
                                        value="De manera atenta me dirijo a ustedes para trasladar los documentos de pago de los siguientes afiliados (as) por: APERTURA, CONTINUACIÓN Y TRASLADO: ">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="despedida" id="despedida" class="form-control"
                                        ...
                                        value="Sin otro particular me suscribo atentamente, ">
                                </div>
                            </div>
                        </div>
                        <div class="row">
